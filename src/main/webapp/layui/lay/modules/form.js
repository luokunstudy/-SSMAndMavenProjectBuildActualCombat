    ...
    o.prototype.render = function(e, t) {
        ...
        d = {
            ...
            radio: function() {
                ...
                t = ["&#xe643;", "&#xe63f;"],
                a = i(".layui-input-block-ra").find("input[type=radio]"),//2017-09-08 单选框样式（圆形）
                n = function(a) {
                    var n = i(this),
			...
			radio_ch: function() {//2017-9-8 单选框样式（方形）
                var e = {
                    radio: ["layui-form-checkbox", "layui-form-checked", "checkbox"],
                    _switch: ["layui-form-switch", "layui-form-onswitch", "switch"]
                },
                t = i(".layui-input-block-ch").find("input[type=radio]"),
                a = function(e, t) {
                    var a = i(this);
                    e.on("click",
                    function() {
                        ...
                        a[0].disabled || (a[0].checked ? (a[0].checked = !1, e.siblings().removeClass(t[1]), e.addClass(t[1]).find("em").text(n[1])) : (a[0].checked = !0, e.siblings().removeClass(t[1]), e.addClass(t[1]).find("em").text(n[0])), layui.event.call(a[0], l, t[2] + "(" + i + ")", {
                            elem: a[0],
                            value: a[0].value,
                            othis: e
                        }))
